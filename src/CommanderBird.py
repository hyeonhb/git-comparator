...
class CommanderBird(ICommander, IVirtualObject):
    ...
    def commander_init(self):
        ...
        for swarm in self.swarm_list:
            for boid in swarm:
                random_position = Vector3D(random.uniform(0, 1024), random.uniform(0, 1024), random.uniform(0, 768))
    ...
    def commander_start(self):
        ...
        for swarm in self.swarm_list:
            for boid in swarm:
                random_velocity = Vector3D(random.uniform(-1, 1), random.uniform(-1, 1), random.uniform(-1, 1))
